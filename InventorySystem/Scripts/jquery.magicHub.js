...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies.topicBroker = this.createHubProxy('topicBroker'); 
        proxies.topicBroker.client = { };
        proxies.topicBroker.server = {
            send: function (topic, message, headers) {
            /// <summary>Calls the Send method on the server-side TopicBroker hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"topic\" type=\"String\">Server side type is System.String</param>
            /// <param name=\"message\" type=\"String\">Server side type is System.String</param>
            /// <param name=\"headers\" type=\"Object\">Server side type is System.Collections.Generic.IDictionary`2[System.String,System.Object]</param>
                return proxies.topicBroker.invoke.apply(proxies.topicBroker, $.merge(["Send"], $.makeArray(arguments)));
             },

            subscribe: function (topic, filter) {
            /// <summary>Calls the Subscribe method on the server-side TopicBroker hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"topic\" type=\"String\">Server side type is System.String</param>
            /// <param name=\"filter\" type=\"String\">Server side type is System.String</param>
                return proxies.topicBroker.invoke.apply(proxies.topicBroker, $.merge(["Subscribe"], $.makeArray(arguments)));
             },

            unsubscribe: function (topic, filter) {
            /// <summary>Calls the Unsubscribe method on the server-side TopicBroker hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"topic\" type=\"String\">Server side type is System.String</param>
            /// <param name=\"filter\" type=\"String\">Server side type is System.String</param>
                return proxies.topicBroker.invoke.apply(proxies.topicBroker, $.merge(["Unsubscribe"], $.makeArray(arguments)));
             }
        };
    ...
    signalR.hub = $.hubConnection("/magic-hub/signalr/", { useDefaultPath: false });
